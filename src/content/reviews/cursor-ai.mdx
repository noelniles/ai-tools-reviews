...
<MetricsGrid 
  metrics={[
    { label: 'Acceptance Rate', value: '43%', change: 28, icon: '✅' },
    { label: 'Avg Latency', value: '180ms', icon: '⚡' },
    { label: 'Codebase Index', value: 'Full', icon: '📚' },
    { label: 'Models Available', value: '5+', icon: '🤖' }
  ]}
/>
