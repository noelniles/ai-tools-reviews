...
1. Forward pass through $L$ layers (typically 80-100 for 175B models)
2. Compute loss across $V$ vocabulary items (typically 50K-100K)
3. Backward pass to compute $P$ parameter gradients (175 billion for GPT-4)
