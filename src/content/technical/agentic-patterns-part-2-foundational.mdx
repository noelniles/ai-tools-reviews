...
<CodeBlock 
  language="python"
  filename="part_1_foundational/prompt_chaining.py"
...
<a href="https://github.com/ai-tools-reviews/agentic-design-patterns/blob/main/part_1_foundational/prompt_chaining.py" target="_blank" rel="noopener noreferrer">View full code →</a>
...
<CodeBlock 
  language="python"
  filename="part_1_foundational/routing.py"
...
<a href="https://github.com/ai-tools-reviews/agentic-design-patterns/blob/main/part_1_foundational/routing.py" target="_blank" rel="noopener noreferrer">View full code →</a>
...
<CodeBlock 
  language="python"
  filename="part_1_foundational/parallelization.py"
  code={`import asyncio
...
<a href="https://github.com/ai-tools-reviews/agentic-design-patterns/blob/main/part_1_foundational/parallelization.py" target="_blank" rel="noopener noreferrer">View full code →</a>
...
<CodeBlock 
  language="python"
  filename="part_1_foundational/reflection.py"
...
<a href="https://github.com/ai-tools-reviews/agentic-design-patterns/blob/main/part_1_foundational/reflection.py" target="_blank" rel="noopener noreferrer">View full code →</a>
...
<CodeBlock 
  language="python"
  filename="part_1_foundational/tool_use.py"
...
<a href="https://github.com/ai-tools-reviews/agentic-design-patterns/blob/main/part_1_foundational/tool_use.py" target="_blank" rel="noopener noreferrer">View full code →</a>
